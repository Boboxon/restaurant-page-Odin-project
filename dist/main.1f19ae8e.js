...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"homegape.js":[function(require,module,exports) {
"use strict";
...
function homePage() {
  ...
  img.setAttribute("src", "https://images.unsplash.com/photo-1531973968078-9bb02785f13d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=977&q=80");
...
var _homegape = _interopRequireDefault(require("./homegape"));
...
(0, _homegape.default)();
(0, _contact.default)();
document.querySelector("#home").addEventListener("click", _homegape.default.bind());
document.querySelector("#menu").addEventListener("click", _menu.default.bind());
document.querySelector("#contact").addEventListener("click", _contact.default.bind());
},{"./button":"button.js","./style":"style.css","./homegape":"homegape.js","./contact":"contact.js","./menu":"menu.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11653" + '/');
